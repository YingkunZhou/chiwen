...
trait ScalarOpConstants {
  ...
  val BR_JR    = 1.U(3.W)  // Jump Register
  val BR_NE    = 2.U(3.W)  // Branch on NotEqual
  val BR_EQ    = 3.U(3.W)  // Branch on Equal
  val BR_GE    = 4.U(3.W)  // Branch on Greater/Equal
  val BR_GEU   = 5.U(3.W)  // Branch on Greater/Equal Unsigned
  val BR_LT    = 6.U(3.W)  // Branch on Less Than
  val BR_LTU   = 7.U(3.W)  // Branch on Less Than Unsigned
