...
import common.{CPUConfig, CSR, MemPortIo}
...
class CtlPath(implicit conf: CPUConfig) extends Module
{
  ...
  val exe_reg_br_type  = RegInit(BR_N)
   ...
   val ctrl_exe_pc_sel = Mux(io.dat.xcpt               , PC_EXC,
                         ...
                         Mux(exe_reg_br_type === BR_NE , Mux(!io.dat.exe_br_eq,  PC_BRJMP, PC_4),
                         Mux(exe_reg_br_type === BR_EQ , Mux( io.dat.exe_br_eq,  PC_BRJMP, PC_4),
                         Mux(exe_reg_br_type === BR_GE , Mux(!io.dat.exe_br_lt,  PC_BRJMP, PC_4),
                         Mux(exe_reg_br_type === BR_GEU, Mux(!io.dat.exe_br_ltu, PC_BRJMP, PC_4),
                         Mux(exe_reg_br_type === BR_LT , Mux( io.dat.exe_br_lt,  PC_BRJMP, PC_4),
                         Mux(exe_reg_br_type === BR_LTU, Mux( io.dat.exe_br_ltu, PC_BRJMP, PC_4),
